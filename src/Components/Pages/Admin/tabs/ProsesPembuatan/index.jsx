...
export default function Component() {
  ...
  const getArticles = async () => {
    ...
    await callable({
      page: meta.activePage, limit: 10, type: 'Proses Pembuatan',
    })
      .then((res) => {
        const {
          activePage,
  ...
  return (
    <Box>
      <Flex justify="space-between">
        <Heading size="lg">Manajemen Proses Pembuatan</Heading>
        <Button colorScheme="blue" onClick={() => handleOpenModal('Buat')}>Buat Proses Pembuatan</Button>
      </Flex>
      <Elements.Table
        isLoading={loading}
