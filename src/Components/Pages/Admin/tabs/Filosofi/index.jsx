...
export default function Component() {
  ...
  const getArticles = async () => {
    ...
    await callable({
      page: meta.activePage, limit: 10, type: 'Filosofi',
    })
      .then((res) => {
        const {
          activePage,
  ...
  return (
    <Box>
      <Flex justify="space-between">
        <Heading size="lg">Manajemen Filosofi</Heading>
        <Button colorScheme="blue" onClick={() => handleOpenModal('Buat')}>Buat Filosofi</Button>
      </Flex>
      <Elements.Table
        isLoading={loading}
